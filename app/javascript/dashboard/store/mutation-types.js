export default {
  ...
  // SIP Trunks
  SET_SIP_TRUNK_UI_FLAG: 'SET_SIP_TRUNK_UI_FLAG',
  SET_SIP_TRUNK: 'SET_SIP_TRUNK',
  ADD_SIP_TRUNK: 'ADD_SIP_TRUNK',
  EDIT_SIP_TRUNK: 'EDIT_SIP_TRUNK',
  DELETE_SIP_TRUNK: 'DELETE_SIP_TRUNK',
