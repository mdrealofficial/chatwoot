...
ActiveRecord::Schema[7.1].define(version: 2026_07_18_134000) do
  ...
  create_table "channel_sip_calls", force: :cascade do |t|
    t.string "phone_number", null: false
    t.integer "account_id", null: false
    t.bigint "sip_trunk_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "phone_number"], name: "index_channel_sip_calls_on_account_id_and_phone_number"
    t.index ["phone_number"], name: "index_channel_sip_calls_on_phone_number", unique: true
    t.index ["sip_trunk_id"], name: "index_channel_sip_calls_on_sip_trunk_id"
  end
  ...
  create_table "sip_trunks", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_sip_trunks_on_account_id"
  end
  ...
  add_foreign_key "sip_trunks", "accounts", on_delete: :cascade
